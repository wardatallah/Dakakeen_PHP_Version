    ...
    <div class="container">
      ...
      <nav>
        <ul>
			...
			<li><a id='go' rel='leanModal' name='signin' href='#signin'><div class='top-info'>Sign In</div></a></li>
...
<div  style="position: absolute; opacity: 1;  left: 30%; top: 50px; width:40%">
			...
			<div id="signup-ct">
				...
				<form action="pass_reset.php" method=post>
					...
					<div class="txt-fld" style="float:bottom;margin:20 0 20 50;">
					<label for="email">E_mail</label>
				    <input name="email" type="text" maxlength=45 size=30>
					</div>
