    ...
    <div class="container">
      ...
      <nav>
        <ul>
			...
			echo "<li><a id='go' rel='leanModal' name='signin' href='#' class='current'><div class='top-info'>Sign In</div></a></li>
...
<!--pop up register -->
  ...
  <div id="signup" style="display: none;position: absolute; opacity: 1; z-index: 11000; left: 50%; margin-top: -150px; top: 50px;">
		 ...
		 <div class="container2" style="padding:15 200 500 200;">
		 <fieldset >
			<div id="signin1"  style="position: absolute; opacity: 1; left: 35%;  top: 50px;">
