    ...
    <div class="container">
      ...
      <nav>
        <ul>
			...
			<li><a href="contacts.php" class="current"><div class="top-info">Contact</div></a></li>
        </ul>
      </nav>
    </div>
	</header>
            ...
            <article>
              ...
              <form id="contacts-form" action="smsg.php" method="post">
                <fieldset>
                  <div class="field">
                    <label>To :</label>
                    <input type="text" name="user" value="<? echo $user_name;?>"/>
					<input type="text" name="iduser" hidden value="<? echo $iduser;?>"/>
                  </div>
                  <div class="field">
                    <label>Message:</label>
