...
<body>
  ...
  <header>
    <div class="container">
      ...
      <nav>
        <ul>
        	<li><a href="index.php" class="current" ><div class='top-info'>Home</div></a></li>
			<?
...
<div class="boxIndent">
	...
	<iframe src="//www.facebook.com/plugins/likebox.php?href=https%3A%2F%2Fwww.facebook.com%2FDakakeen.syr&amp;width=225&amp;height=590&amp;colorscheme=light&amp;show_faces=true&amp;header=true&amp;stream=true&amp;show_border=true&amp;appId=277894992373876" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:225px; height:590px;" allowTransparency="true"></iframe>
	  ...
	  <ul id="vmproduct" class="vmproduct_new" style="margin-top:30px" >
				...
				<li class="items">
				<div class="product-box spacer" style="height: 425px;width:425px;">
					  <div class="browseImage">
					  <div class="new"></div>
						<a href="" class="img2"><img src='images/android_logo-t2.png'  border=0 width=300 height=300 alt='APK Image' class='browseProductImage'/>
						</a> 
					   </div>
					   <div class='button'>
						<button style='cursor: pointer' onclick='window.location.href=""' type='submit' >Download Our Client's Android App</button>
					   </div>
				</div>
				<div class="product-box spacer" style="height: 425px;width:425px;">
					  <div class="browseImage">
					  <div class="new"></div>
						<a href="http://files.appsgeyser.com/Dakakeen%20Guests.apk" class="img2"><img src='images/android_logo-t1.png'  border=0 width=300 height=300 alt='APK Image' class='browseProductImage'/>
						</a> 
					   </div>
					   <div class='button'>
						<button style='cursor: pointer' onclick='window.location.href="http://files.appsgeyser.com/Dakakeen%20Guests.apk"' type='submit' >Download Our Guest's Android App</button>
					   </div>
				</div>
				</li>
				<li class="items">
				<div class="product-box spacer" style="height: 425px;width:425px;">
					  <div class="browseImage">
					  <div class="new"></div>
						<a href="ext.crx" class="img2"><img src='images/ext_puzzle_chrome.png'  border=0 width=300 height=300 alt='Extension Image' class='browseProductImage'/>
						</a> 
					   </div>
					   <div class='button'>
						<button style='cursor: pointer' onclick='window.location.href="ext.crx"' type='submit' >Download Our Chrome Extension</button>
					   </div>
				</div>
				<div class="product-box spacer" style="height: 425px;width:425px;">
					  <div class="browseImage">
					  <div class="new"></div>
						<a href="rss.php" class="img2"><img src='images/rss.png'  border=0 width=300 height=300 alt='Extension Image' class='browseProductImage'/>
						</a> 
					   </div>
					   <div class='button' style='padding:15 30 10 0'>
						<button style='cursor: pointer;width:360' onclick='window.location.href="rss.php"' type='submit' >RSS</button>
					   </div>
				</div>
				</li>
