...
<div id="signin" style="display: none;position: absolute; opacity: 1; z-index: 11000; left: 50%;  top: 50px;">
		 ...
		 <div class="container2" style="padding:15 200 20 200;">
		 <fieldset style="border: 2px #f1f1f1 solid;">
		 <?
		
		$id=$_GET["id"];
		$sql = "select img_path,price,count,com_id from goods where good_Id=$id";
		...
		echo "<div style='margin-left:30' ><img src='$img_path'  border=0 width=350 height=300 alt='product $id' />
				<br><span><label class='good_label'>Price :   </label>$price</span><br><span><label class='good_label'>Count Available :   </label>$counter</span></div>";
		
		?>
		 <div style="padding:20 0 20 0">
			<form id="contacts-form" method=post action="buy_good_php.php" enctype="multipart/form-data">
			
			<div class="field"  hidden disabled>
			    <input type="text" name="id" value="<?echo $id;?>"/>
				<input type="text" name="com_id" value="<?echo $com_id;?>"/>
			</div>
			<div class="field" >
